          ...
          <div class="accordion-body">
            ...
            <div>
              ...
              <form id="myform" @submit="ratestar">
                <fieldset>
                  <input type="radio" v-model="selectedOption" name="rating" value="5" id="rate1"><label for="rate1">⭐</label>
                  <input type="radio" v-model="selectedOption" name="rating" value="4" id="rate2"><label for="rate2">⭐</label>
                  <input type="radio" v-model="selectedOption" name="rating" value="3" id="rate3"><label for="rate3">⭐</label>
                  <input type="radio" v-model="selectedOption" name="rating" value="2" id="rate4"><label for="rate4">⭐</label>
                  <input type="radio" v-model="selectedOption" name="rating" value="1" id="rate5"><label for="rate5">⭐</label>
                </fieldset>
              </form>
            </div>
